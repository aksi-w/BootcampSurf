    ...
    runFeature(
      ...
      run: () {
        runScenario(
          ...
          description: null,
          path:
              'C:\\Users\\popov\\CSF\\qa-school-autotests-qa-school-e2e-example\\examples\\profile\\.\\integration_test\\features\\profile.feature',
          tags: <String>[],
          steps: [
            (
            ...
            (
              ...
              return await runStep(
                name: 'И Я перехожу далее к интересам',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
            ...
            (
              ...
              return await runStep(
                name: 'И Я перехожу далее информации о себе',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
